...
RF24  radio(7, 8);               // (CE=7, CSN=5) create object "radio" for RF24,
...
long D[8] = {0, 0, 10439, 5, 923, 456, 111111, 5};              // 4 bytes elements <- 32/4 = 8
...
void loop(){
    ...
    for (byte j = 0; j < N; j++)            // jump through channels 2,4,..,122
    {
            ...
            //B[j] = D[0]; 
            radio.setChannel(j);
            radio.write(&D, sizeof(D));            // send 32 bytes of data
